report 51202 "Standard Sales - Abono"
{
    RDLCLayout = './Report.50202.AbonoVenta.rdlc';
    ...
    dataset
    {
        dataitem(Header; "Sales Cr.Memo Header")
        {
            ...
            dataitem(Line; "Sales Cr.Memo Line")
            {
                ...
                column(LineAmount_Line_Lbl; LineAmountLineLbl)
                {
                }
                ...
                column(VATPct_Line_Lbl; VATPctLineLbl)
                {
                }
            ...
            dataitem(VATClauseLine; "VAT Amount Line")
            {
                ...
                trigger OnAfterGetRecord()
                var
                    ReporAbono: Report "Standard Sales - Credit Memo";
                begin
    ...
    var
        ...
        UnitPrice_Lbl: Label 'Precio'; //PRICE
                                       //UnitPrice_Lbl: Label 'Precio Venta';
        LineAmount_LineLbl: Label 'TOTAL'; //TOTAL
        SalesCreditMemoLbl: Label 'No.Credit Memo'; //Numero de Abono
        Description_LineLbl: Label 'DESCRIPTION';//CONCEPT Description //Descripción
        Quantity_Line_Lbl: Label 'Ud./Uds.';
        ExternalDocumentNoLlb: Label 'Customer Credit Number';//  No.Abono Cliente
        ...
        VATAmountLCYLbl: Label 'Importe IVA';
        //VATBaseLbl: Label 'VAT Base';
        VATBaseLbl: Label 'Importe Base';
        // VATBaseLCYLbl: Label 'VAT Base (LCY)';
        LineAmountLineLbl: Label 'TOTAL';
        VATPctLineLbl: Label 'VAT';//
        VATBaseLCYLbl: Label 'Base IVA';
