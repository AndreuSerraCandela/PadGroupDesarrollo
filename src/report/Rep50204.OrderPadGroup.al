report 51204 "Order_PadGroup"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Report.50204.Order_PadGroup.rdlc';
    Caption = 'Order';
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            column(OrderDateCaption; "Purchase Header".FieldCaption("Order Date")) { }
            column(OrderDate; "Purchase Header"."Order Date") { }
            column(CodOfertaCaption; "Purchase Header".FieldCaption("Cod. Oferta")) { }
            column(CodOferta; "Purchase Header"."Cod. Oferta") { }
            column(NumPedidoProveedorCaption; "Purchase Header".FieldCaption("Vendor Order No.")) { }
            column(NumPedidoProveedor; "Purchase Header"."Vendor Order No.") { }
            column(DueDateCaption; "Purchase Header".FieldCaption("Due Date")) { }
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        /*       column(VATIdentifier_PurchLine; "Purchase Line"."VAT Identifier")
                               ...
                               */
                        column(VATIdentifier_PurchLine; "Purchase Line"."VAT %")
                        {
                        }
                        ...
                        column(Quantity_PurchLineCaption; Quantity_PurchLineCaption) { }
                        ...
                        column(WorKDescription; "Purchase Line"."Work Description") { }
                        column(WorKDescriptionheader; "Purchase Header"."Work Description") { }
                        column(sDocsManquants; sDocsManquants) { }
                        column(sDocsManquantsheader; sDocsManquantsheader) { }
                        column(ExtendedDescription; Format(ExtendedDescriptionBigText))
                        //MayBlob Item Managment LINEAS
                        {
                        }
                        column(sDocsManquantBool; sDocsManquantBool) { }
                        ...
                        begin
                            ...
                            "Purchase Line".CalcFields("Purchase Line"."Work Description");
                            sDocsManquants := '';
                            sLine := '';
                            cCr := 10;
                            ...
                            if "Purchase Line"."Work Description".HasValue then begin
                                "Purchase Line"."Work Description".CreateInStream(osInStream);
            ...
            begin
                ...
                "Purchase Header".CalcFields("Work Description");
                sDocsManquantsheader := '';
                sLine := '';
                cCr := 10;
                sCrLf := Format(cCr, 1); // Display line break
                Clear(osInStream);

                if "Purchase Header"."Work Description".HasValue then begin

                    MayBlobMgt.f_BlobGetFromFieldRef2BigText("Purchase Header", "Purchase Header".FieldNo("Work Description"), ExtendedDescriptionBigText);
                    // "Purchase Header"."Work Description".CreateInStream(osInStream);
                    // while not osInStream.EOS do begin
                    //     osInStream.ReadText(sLine);
                    //     sDocsManquantsheader += sLine + sCrLf;
                    // end;
                end;
    ...
    var
        MayBlobMgt: Codeunit Eventos;
        ExtendedDescriptionBigText: BigText;
        sDocsManquants: Text;
        sDocsManquantsheader: Text;
        sDocsManquantBool: Boolean;
