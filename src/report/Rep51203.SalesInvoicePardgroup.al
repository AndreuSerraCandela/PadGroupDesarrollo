report 51203 "SalesInvoice-Pardgroup"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Report.50203.FacturaVenta.rdl';

    Caption = 'Sales - Invoice Pard', comment = 'ESP="Factura Pard"';
                    ...
                    dataitem(VATClauseEntryCounter; "Integer")
                    {
                        ...
                        begin
                            ...
                            if not VATClause.Get(VATAmountLine."VAT Clause Code") then
                                CurrReport.Skip();
                            VATClause.GetDescriptionText("Sales Invoice Header");
                        end;
    ...
    //                       4, "Sales Invoice Header"."No.", 0, 0, DATABASE::Contact,
    ...
    //                 else
    //                     SegManagement.LogDocument(
    //                       4, "Sales Invoice Header"."No.", 0, 0, DATABASE::Customer,
    ...
    var
        ...
        VATIdent_SalesInvLineCaption: Label 'Tipo IVA';
